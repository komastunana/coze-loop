...
type kOpenAPIServiceClient struct {
	*kClient
}

func (p *kOpenAPIServiceClient) IngestTraces(ctx context.Context, req *openapi.IngestTracesRequest, callOptions ...callopt.Option) (r *openapi.IngestTracesResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.IngestTraces(ctx, req)
}

func (p *kOpenAPIServiceClient) OtelIngestTraces(ctx context.Context, req *openapi.OtelIngestTracesRequest, callOptions ...callopt.Option) (r *openapi.OtelIngestTracesResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
