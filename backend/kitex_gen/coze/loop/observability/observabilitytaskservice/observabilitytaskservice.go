...
var (
	observabilityTaskServiceServiceInfo = NewServiceInfo()
)

// for server
func serviceInfo() *kitex.ServiceInfo {
	return observabilityTaskServiceServiceInfo
}
...
func newServiceInfo() *kitex.ServiceInfo {
	serviceName := "ObservabilityTaskService"
	handlerType := (*observability.ObservabilityTaskService)(nil)
