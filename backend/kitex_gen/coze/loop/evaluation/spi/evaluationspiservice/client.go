...
func NewClient(destService string, opts ...client.Option) (Client, error) {
	...
	return &kEvaluationSPIServiceClient{
...
func (p *kEvaluationSPIServiceClient) InvokeEvalTarget(ctx context.Context, req *spi.InvokeEvalTargetRequest, callOptions ...callopt.Option) (r *spi.InvokeEvalTargetResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.InvokeEvalTarget(ctx, req)
}

func (p *kEvaluationSPIServiceClient) AsyncInvokeEvalTarget(ctx context.Context, req *spi.AsyncInvokeEvalTargetRequest, callOptions ...callopt.Option) (r *spi.AsyncInvokeEvalTargetResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
