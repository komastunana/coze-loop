...
// Source: github.com/coze-dev/coze-loop/backend/modules/evaluation/domain/component/rpc (interfaces: ITagRPCAdapter)
//
...
func (m *MockITagRPCAdapter) BatchGetTagInfo(arg0 context.Context, arg1 int64, arg2 []int64) (map[int64]*entity.TagInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BatchGetTagInfo", arg0, arg1, arg2)
	ret0, _ := ret[0].(map[int64]*entity.TagInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockITagRPCAdapter) GetTagInfo(arg0 context.Context, arg1, arg2 int64) (*entity.TagInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTagInfo", arg0, arg1, arg2)
	ret0, _ := ret[0].(*entity.TagInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
